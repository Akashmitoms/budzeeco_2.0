...
import { faAngleDown, faAnglesRight, faBars, faBullseye, faChartLine, faChevronRight, faCircleCheck, faCircleDollarToSlot, faCoins, faEnvelope, faFileInvoiceDollar, faFileShield, faFileSignature, faGraduationCap, faHeadset, faHouseCircleCheck, faMapLocation, faMapLocationDot, faMobileScreenButton, faMoneyBills, faMoneyBillTrendUp, faPeopleArrows, faPersonCircleCheck, faPhoneVolume, faPiggyBank, faSackDollar, faUserShield, faXmark } from '@fortawesome/free-solid-svg-icons'
...
library.add(faPiggyBank, faMoneyBillTrendUp, faCoins, faChartLine, faFileInvoiceDollar, faHouseCircleCheck, faSackDollar, faFileSignature, faCircleDollarToSlot,
    ...
    faFileShield, faCircleCheck, faAngleDown, faXmark, faPersonCircleCheck, faHeadset, faPhoneVolume, faMobileScreenButton, faPeopleArrows,
faUserShield, faLinkedin, faYoutube )
