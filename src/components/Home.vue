    ...
    <div id="smooth-wrapper" class="mil-wrapper">
        ...
        <div class="container">
          ...
          <nav class="mil-top-menu">
            <ul>
              ...
              <li class=""><a href="/myMentor">MY MENTOR​</a></li>
      ...
      <div id="smooth-content">
            ...
            <div class="row align-items-center">
              <div class="col-xl-6">
                <div class="mil-banner-text">
                  <h6 class="mil-text-gradient-2 mil-mb-20">
                    Send money globally with Plax
                  </h6>
                  <h1 class="mil-display mil-text-gradient-3 mil-mb-60">
                    Your Ally for Financial Control
                  </h1>
                  <div class="mil-buttons-frame">
                    ...
                    ><a
                      ...
                      class="mil-btn mil-md mil-light mil-add-play has-popup-video"
                      >Watch tutorial</a
                    >
                  </div>
                </div>
            ...
            >
              <div class="col-xl-6 mil-mb-80">
                ...
                <p class="mil-text-m mil-soft mil-mb-60 mil-up">
                  ...
                  graphs <br />that give you visual insights into your spending
                  and saving habits.
                </p>
                  ...
                  <li>
                    <div class="mil-up">
                      ...
                      <p class="mil-text-m mil-soft">
                        Experience exceptional service around the world.
                        <br />With our Plax® Global Service, we provide
                        assistance<!-- -->
                        <br />and support, wherever you are, to ensure your
                        peace.
                      </p>
                    </div>
                  </li>
                  <li>
                    <div class="mil-up">
                      ...
                      <p class="mil-text-m mil-soft">
                        ...
                        <br />points with every purchase and access exclusive
                        <br />rewards, from trips to high-quality products.
                      </p>
                    </div>
                  </li>
                </ul>
        ...
        <div class="mil-cta mil-up">
          <div class="container">
            <div
              class="mil-out-frame mil-visible mil-illustration-fix mil-p-160-0"
            >
              <div class="row align-items-end">
                <div class="mil-text-center">
                  <h2 class="mil-mb-30 mil-up">
                    Protected coverage on your <br />purchases with Plax
                    Standard
                  </h2>
                  <p class="mil-text-m mil-soft mil-mb-60 mil-up">
                    Enjoy instant coverage against theft or accidental damage<!-- -->
                    <br />for the first forty-five (45) days from the date of
                    purchase.
                  </p>
                </div>
              </div>
              ...
              <div class="col-xl-4 mil-mb-30">
                <div class="mil-icon-box mil-with-bg mil-center mil-up">
                  ...
                  <p class="mil-text-s mil-soft mil-up">
                    Enjoy instant coverage against theft or accidental damage
                    for the first forty-five (45) days from the date of
                    purchase.
                  </p>
                </div>
              </div>
            ...
            <div class="mil-out-frame mil-p-160-100">
              <div class="row align-items-end">
                ...
                <div class="col-xl-4 mil-mb-80 mil-up">
                  <a
                    class="mil-btn mil-m mil-add-arrow mil-adaptive-right"
                    href="register.html"
                    >Learn More</a
                  >
                </div>
                ...
                <div class="col-xl-4 mil-mb-60">
                  <div class="mil-icon-box">
                    ...
                    <p class="mil-text-m mil-soft mil-up">
                      Make instant transfers and experience <br />Plax&#x27;s
                      unparalleled speed with every transaction.
                    </p>
                  </div>
                </div>
                <div class="col-xl-4 mil-mb-60">
                  <div class="mil-icon-box">
                    ...
                    <p class="mil-text-m mil-soft mil-up">
                      Connect with the world through our <br />global network
                      that spans more than <br />170 countries.
                    </p>
                  </div>
                </div>
                <div class="col-xl-4 mil-mb-60">
                  <div class="mil-icon-box">
                    ...
                    <p class="mil-text-m mil-soft mil-up">
                      Protect your assets with our robust <br />security
                      protocols and cutting-edge <br />technologies.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div class="row justify-content-between align-items-center">
              <div class="col-xl-6 mil-mb-80">
                ...
                <p class="mil-text-m mil-soft mil-mb-60 mil-up">
                  ...
                  alert.<!-- -->
                  <br />Your security is our priority, are always one step
                  forward.
                </p>
                <ul class="mil-list-2 mil-type-2 mil-mb-60">
                  <li>
                    <div class="mil-up">
                      ...
                      <p class="mil-text-m mil-soft">
                        Plax monitors the devices connected to your
                        <br />account. If we detect activity from a new device
                        or <br />an unusual change, we will notify you.
                      </p>
                    </div>
                  </li>
                </ul>
                <div class="mil-up">
                  <a
                    class="mil-btn mil-button-transform mil-m mil-add-arrow"
                    href="about.html"
                    >More Information</a
                  >
                </div>
                ...
                <ul class="mil-list-2 mil-type-2">
                  <li>
                    <div class="mil-up">
                      ...
                      <p class="mil-text-m mil-soft">
                        Notifications allow you to take immediate action in
                        <br />case of unauthorized transactions or unusual
                        activities.
                      </p>
                    </div>
                  </li>
                  <li>
                    <div class="mil-up">
                      ...
                      <p class="mil-text-m mil-soft">
                        Keep track of your financial activity and the response
                        to alert. <br />Your security is our priority, are
                ...
                <div class="swiper-slide">
                  <blockquote class="mil-with-bg">
                    <svg
                      ...
                      class="mil-mb-30 mil-up mil-accent"
                    >
                      <path
                    ...
                    <p class="mil-text-m mil-mb-30 mil-up">
                      I had never felt so connected to my finances. The instant
                      alerts from Plax keep me informed in real time, giving me
                      a feeling of total control. But the result, the lion needs
                      to drink members.
                    </p>
                ...
                <div class="swiper-slide">
                  <blockquote class="mil-with-bg">
                    ...
                    <p class="mil-text-m mil-mb-30 mil-up">
                      ...
                      financial defender. Proactive alerts give me confidence
                      that my security is in good hands.
                    </p>
                    <div class="mil-customer">
                      <img
                        src="/img/faces/2.jpg"
                ...
                <div class="swiper-slide">
                  <blockquote class="mil-with-bg">
                    ...
                    <p class="mil-text-m mil-mb-30 mil-up">
                      ...
                      complete view of my financial activity. It&#x27;s like
                      having a personal security assistant always.
                    </p>
                    <div class="mil-customer">
                      <img
                        src="/img/faces/3.jpg"
        ...
        <div class="mil-cta mil-up">
          <div class="container">
            <div
              class="mil-out-frame mil-visible mil-image mil-illustration-fix mil-p-160-0"
            >
              <div class="row align-items-end">
                <div class="mil-text-center">
                  <h2 class="mil-mb-30 mil-light mil-up">
                    Buy with Confidence, Guaranteed <br />Protection for your
                    purchases
                  </h2>
                  <p class="mil-text-m mil-dark-soft mil-mb-60 mil-up">
                    Discover how we make each purchase a safe and reliable
                    <br />experience for you.
                  </p>
                  <div class="mil-up mil-mb-60">
                    <a
                      class="mil-btn mil-button-transform mil-md mil-add-arrow"
                      href="register.html"
                      >Protect My Purchases</a
                    >
                  </div>
                </div>
              </div>
          ...
          <div class="container">
            <div class="row">
              ...
              <div class="col-xl-3 mil-mb-80">
                ...
                <form id="subscribeForm" class="mil-subscripe-form-footer">
                  <input
                    class="mil-input"
                    type="email"
                    placeholder="Email"
                    ...
                    name="EMAIL"
                  /><button type="submit">
                    <i class="far fa-envelope-open mil-dark"></i>
                  </button>
            ...
            <div class="mil-footer-bottom">
              <div class="row">
                ...
                <div class="col-xl-6">
                  <p
                    class="mil-text-s mil-text-right mil-sm-text-left mil-soft"
                  >
                    Developed by<!-- -->
